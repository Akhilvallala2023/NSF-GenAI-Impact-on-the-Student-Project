...
folder_names = ["controversial_post.csv", "gilded_post.csv", "hot_post.csv","new_post.csv", "top_post.csv", "random_rising_post.csv"
]



base_input_dir = "/home/avallala2023/Desktop/Combined/collected_files/posts"
base_output_dir = "/home/avallala2023/Desktop/Combined/collected_files/posts/cleaned"
...
for folder in folder_names:
	...
	df = df.sort_values(by=["post_id", "post_upvotes"], ascending=[True, False])
